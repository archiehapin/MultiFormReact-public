...
const ThankYou = () => {
  return (
    <div className="flex h-[600px] md:h-[620px]">
      <div className="-mx-1 flex flex-col items-center justify-center gap-3 text-center">
        <svg
        ...
        <div>
          <h2 className="mt-3 text-2xl font-bold text-a_Marine_blue">
            Thank you!
          </h2>
          <p>
